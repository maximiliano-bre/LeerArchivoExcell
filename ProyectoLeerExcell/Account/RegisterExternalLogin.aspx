<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/Site.Master" CodeBehind="RegisterExternalLogin.aspx.vb" Inherits="ProyectoLeerExcell.RegisterExternalLogin" Async="true" %>

<%@ Import Namespace="ProyectoLeerExcell" %>
